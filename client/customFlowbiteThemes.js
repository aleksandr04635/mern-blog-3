...
export const customDropdownTheme = {
  ...
  floating: {
    ...
    base: "z-10 w-fit divide-y divide-gray-100 rounded shadow focus:outline-none overflow-hidden",
    content: "py-1 text-sm text-gray-700 dark:text-gray-200 ",
    divider: "my-0 h-px bg-gray-100 dark:bg-dark-active-bg",
    header: "block px-4 py-2 text-sm text-gray-700 dark:text-white",
    hidden: "invisible opacity-0",
    item: {
      container: "",
      base: "flex w-full cursor-pointer  items-center justify-start px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 focus:bg-gray-100 focus:outline-none dark:text-white dark:hover:bg-dark-active-bg dark:hover:text-white dark:focus:bg-dark-active-bg dark:focus:text-white",
      icon: "mr-2 h-4 w-4",
    },
    style: {
      dark: "bg-gray-900 text-white dark:bg-gray-700 ",
      light: "border border-gray-200 bg-white text-gray-900 ",
      auto: "border  border-gray-200 bg-white  text-gray-900 dark:border-none dark:bg-dark-additional-bg/40 dark:text-white",
    },
    target: "w-fit",
  },
